...
## Solution
Generate a rsa key and copy it to all servers
```
...
Update inventory file with ansible_user for all servers.
```
[appservers]
...
On jump host, ping a specific server and validate the output
```
