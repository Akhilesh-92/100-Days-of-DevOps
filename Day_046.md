...
## Solution
1. Create a docker compose file `/opt/itadmin/docker-compose.yml` on App Server 2
```sh
services:
  web:
...
2. Execute the docker compose and create containers and verify the connecton
```sh
