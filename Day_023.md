...
## Solution
1. Login to Gitea UI using the link given in lab
2. Enter the username `jon` and Password `Jon_pass123`
3. Navigate to repository `sarah/story-blog` and click on fork option.
