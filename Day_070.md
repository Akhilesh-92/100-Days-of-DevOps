...
## Solution
*Go to Manage Jenkins -> Users -> Create user -> Add details*

*Go to Manage Jenkins -> Available Plugins -> Matrix Authorization Strategy -> Install -> restart Jenkins*

*Go to Manage Jenkins -> System -> Authorization -> select 'Project-based Matrix Authorization Strategy' -> Add_user -> mark/admin*

*Create a new freestyle job -> Build -> configure -> Inherit strategy -> Add user -> mark -> give read permissions.*
