...
## Solution
1. *Go to Manage Jenkins -> Users -> Create user -> Add details*

2. *Go to Manage Jenkins -> Available Plugins -> Matrix Authorization Strategy -> Install -> restart Jenkins*

3. *Go to Manage Jenkins -> System -> Authorization -> select 'Project-based Matrix Authorization Strategy' -> Add_user -> mark/admin*

4. *Create a new freestyle job -> Build -> configure -> Inherit strategy -> Add user -> mark -> give read permissions.*
