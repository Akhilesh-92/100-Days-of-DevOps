...
## Solution
1. *Go to Manage Jenkins -> Available Plugins -> Pipeline -> Install -> restart Jenkins*

2. *Go to Manage Jenkins -> credentials -> click on system creds -> Add new storage credential -> Add username, password etc.*
...
5. *Verify the build is successfull after triggering it.*
