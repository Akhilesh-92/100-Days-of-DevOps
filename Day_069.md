...
## Solution
1. *Login to Jenkins using creds -> Manage Jenkins -> Plugins -> Available Plugins*
> Search for required plugins, Install and restart.

2. Verify required plugins installed correctly - 
