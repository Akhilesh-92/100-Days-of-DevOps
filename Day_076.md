...
1. *Go to Manage Jenkins -> Available Plugins -> Matrix Authorization Strategy -> Install -> restart Jenkins*

2. *Go to Manage Jenkins -> Security -> Authorization -> Project based Matrix Authorization Strategy -> Add admin user -> Give all permissions*

3. *Go to Packgaes Job -> Configure -> Enable project based security -> Inherit permissions from parent ACL -> Add users sam and rohan -> Given permissions need to be applied and save.*
